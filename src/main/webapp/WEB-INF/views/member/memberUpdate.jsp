...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#cancelBtn").on('click', function(){
			document.location="/member/member?userid=${memberVo.userid}"
		})
					...
					<div class="container-fluid">
						...
						<div class="card">
							<div class="register-card-body">
								<form id="frm"  role="form" class="form-horizontal" action="${cp }/member/update" method="POST" enctype="multipart/form-data">
									<div class="input-group mb-3">
										<div class="mailbox-attachments clearfix" style="text-align: center; width:100%;">
											<div class="mailbox-attachment-icon has-img" id="pictureView" style="border: 1px solid green; height: 200px; width: 140px; margin: 0 auto;">
												<img src="${cp }/profileImgView?userid=${memberVo.userid}" id="pictureViewImg" style="width:100%; height:100%;"/>
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input name="userid" type="text" class="form-control" id="userid" placeholder="회원 id" value="${memberVo.userid }" READONLY>
									...
									<div class="form-group row">
										...
										<div class="col-sm-3 input-group-sm">
											<input name="addr1" type="text" class="form-control" id="addr1" placeholder="주소" readonly value="${memberVo.addr1 }">
										</div>
										<div class="col-sm-3 input-group-sm">
